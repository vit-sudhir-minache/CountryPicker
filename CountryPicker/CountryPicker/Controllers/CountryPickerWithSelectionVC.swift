...
open class CountryPickerWithSectionVC: CountryPickerVC {
    ...
    open override class func presentController(on viewController: UIViewController,
                                               handler:@escaping (_ country: Country) -> Void) -> CountryPickerWithSectionVC {
        let controller = CountryPickerWithSectionVC()
...
internal extension CountryPickerWithSectionVC {
...
extension CountryPickerWithSectionVC {
